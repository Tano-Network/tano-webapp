...
//   asset: vault.asset,
//   icon: vault.iconChar,
//   totalLocked: "0.00", // Placeholder, as this data is not in constants.ts
//   apy: "0.0%", // Placeholder, as this data is not in constants.ts
//   minted: "0.00",
//   whitelistContract: vault.assetManagementAddress,
...
//       ? "active"
//       : "coming-soon",
//   description: vault.shortDescription,
//   totalMinted: "0",
// }));
...
//           value={vaults.find((v) => v.id === "tdoge")?.totalMinted || "0.00"}
//           description="Available for trading"
//           delay={100}
//         />
//         <StatCard
//           icon={<Coins size={20} className="text-primary" />}
//           label="Total t-BTC Minted"
//           value={vaults.find((v) => v.id === "tbtc")?.totalMinted || "0.00"}
//           description="Available for trading"
//           delay={200}
//         />
//         <StatCard
...
//           value={vaults.find((v) => v.id === "txrp")?.totalMinted || "0.00"}
//           description="Available for trading"
//           delay={300}
//         />
//         <StatCard
    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
        ...
        <StatCard
          icon={<Coins size={20} className="text-primary" />}
          label="Total t-DOGE Minted"
          value={totalMintedById["tdoge"] || "0.00"}
          description="Available for trading"
          delay={100}
        />
        <StatCard
          icon={<Coins size={20} className="text-primary" />}
          label="Total t-BTC Minted"
          value={totalMintedById["tbtc"] || "0.00"}
          description="Available for trading"
          delay={200}
        />
        <StatCard
          icon={<Coins size={20} className="text-primary" />}
          label="Total t-XRP Minted"
          value={totalMintedById["txrp"] || "0.00"}
          description="Available for trading"
          delay={300}
        />
        <StatCard
